...
public class DoomPower extends BasePower {
    public static final String POWER_ID = ("HegemonMod:" + DoomPower.class.getSimpleName());
    ...
    @Override public void atStartOfTurn() { // Trigger the power's effect
    ...
    @Override public void stackPower(int stackAmount) { // on gaining an additional instance
