...
public class MysteriousPower extends BasePower {
    public static final String POWER_ID = ("HegemonMod:" + MysteriousPower.class.getSimpleName());
    ...
    @Override public AbstractPower makeCopy() {return new MysteriousPower(owner, amount);}
}
