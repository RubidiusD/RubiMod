...
public class SnakePower extends BasePower {
    public static final String POWER_ID = ("HegemonMod:" + SnakePower.class.getSimpleName());
    private static final PowerType TYPE = PowerType.BUFF;
    private static final boolean TURN_BASED = false;

    public SnakePower(AbstractCreature owner, int amount) { super(POWER_ID, TYPE, TURN_BASED, owner, amount);     }
