package HegemonMod.character;

import HegemonMod.cards.skills.starter.MidnightEyes;
...
import HegemonMod.cards.attacks.starter.Strike;
import HegemonMod.cards.skills.starter.CloakofNight;
import HegemonMod.cards.skills.starter.Defend;
import HegemonMod.relics.MysteriousStranger;

import java.util.ArrayList;

import static HegemonMod.HegemonMod.characterPath;

public class Hegemon extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = ("HegemonMod:" + Hegemon.class.getSimpleName()); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum(name = "Hegemon") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "Hegemon") @SuppressWarnings("unused")
        ...
        private static final Color cardColor = new Color(12f/255f, 12f/255f, 18f/255f, 1f);
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new Hegemon(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    @Override public AbstractCard getStartCardForEvent() {
    ...
    @Override public int getAscensionMaxHPLoss() {
    ...
    @Override public Color getCardRenderColor() {
        return cardRenderColor;
    }

    @Override public Color getCardTrailColor() {
        return cardTrailColor;
    }

    @Override public Color getSlashAttackColor() {
        return slashAttackColor;
    }

    @Override public BitmapFont getEnergyNumFont() {
    ...
    @Override public String getCustomModeCharacterButtonSoundKey() {
    ...
    @Override public String getLocalizedCharacterName() {
        return getNames()[0];
    }
    @Override public String getTitle(PlayerClass playerClass) {
        return getNames()[1];
    }
    @Override public String getSpireHeartText() {
        return getText()[1];
    }
    @Override public String getVampireText() {
    ...
    @Override public AbstractCard.CardColor getCardColor() {
