...
import HegemonMod.util.TriFunction;
...
import static HegemonMod.util.GeneralUtils.removePrefix;
import static HegemonMod.util.TextureLoader.getCardTextureString;
    ...
    @Override public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    HegemonMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
